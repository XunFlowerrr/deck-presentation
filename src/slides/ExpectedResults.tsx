...
import {
  images,
  academicBadges as ACADEMIC,
  industrialBadges as INDUSTRIAL,
  expectedResultsHeader,
} from "../content/slides/expected-results";

const { relaxImg, frustImg } = images;
...
export function ExpectedResults() {
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={expectedResultsHeader.label}
        title={expectedResultsHeader.title}
        highlight={expectedResultsHeader.highlight}
        titleSize={64}
        tagline={
          <ThaiText en={expectedResultsHeader.tagline.en}>
            {expectedResultsHeader.tagline.th}
          </ThaiText>
        }
        paddingBottom={20}
        marginBottom={24}
