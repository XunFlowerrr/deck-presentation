...
import { sharePointSyncHeader } from "../content/slides/system-slides";
...
export function SharePointSync() {
  ...
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={sharePointSyncHeader.label}
        title={sharePointSyncHeader.title}
        highlight={sharePointSyncHeader.highlight}
        tagline={sharePointSyncHeader.tagline}
        marginBottom={18}
      />
