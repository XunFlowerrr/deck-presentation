...
import { messyBox } from "../content/assets";
...
export function WhySystemFails() {
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={whySystemFailsHeader.label}
        title={whySystemFailsHeader.title}
        highlight={whySystemFailsHeader.highlight}
        tagline={whySystemFailsHeader.tagline}
        marginBottom={28}
      />
          ...
          {gaps.map((gap, i) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  <ThaiText en={gap.desc.en}>{gap.desc.th}</ThaiText>
                </p>
              </div>
            </motion.div>
          ))}
