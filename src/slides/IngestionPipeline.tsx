...
import {
  pipelineSteps as STEPS,
  ingestionPipelineHeader,
} from "../content/slides/ingestion-pipeline";
...
export function IngestionPipeline() {
  ...
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={ingestionPipelineHeader.label}
        title={ingestionPipelineHeader.title}
        highlight={ingestionPipelineHeader.highlight}
        tagline={ingestionPipelineHeader.tagline}
        marginBottom={20}
      />
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0, position: "relative" }}>
                  ...
                  >
                    <ThaiText en={step.body.en}>{step.body.th}</ThaiText>
                  </p>
                </div>
                <div
                  style={{
