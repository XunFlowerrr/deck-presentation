...
import {
  ...
  futureWork as FUTURE_WORK,
  limitations as LIMITATIONS,
  futureWorkHeader,
} from "../content/slides/future-work";
...
const ICON_MAP = {
  ...
  Chart: ChartIcon,
  Gear: GearIcon,
} satisfies Record<string, React.ComponentType<{ color: string }>>;
...
export function FutureWork() {
  return (
    ...
    >
      <SlideHeader
        label={futureWorkHeader.label}
        title={futureWorkHeader.title}
        highlight={futureWorkHeader.highlight}
        tagline={futureWorkHeader.tagline}
      />
        ...
        >
          {ACHIEVEMENTS.map((a, i) => (
            ...
            >
              ...
              >
                {(() => {
                  const IconComp = ICON_MAP[a.iconKey];
                  return <IconComp color={a.color} />;
                })()}
              </div>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  <ThaiText en={a.desc.en}>{a.desc.th}</ThaiText>
                </p>
              </div>
            </motion.div>
          ))}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {LIMITATIONS.map((lim, i) => (
                ...
                >
                  ...
                  >
                    <ThaiText en={lim.en}>{lim.th}</ThaiText>
                  </div>
                </div>
              ))}
            </div>
            ...
            {FUTURE_WORK.map((fw, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 18, color: "#6B7280", lineHeight: 1.6 }}
                  >
                    <ThaiText en={fw.desc.en}>{fw.desc.th}</ThaiText>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      >
        Project{" "}
        <GradientText from="#7C3AED" to="#A855F7" style={{ fontWeight: 800 }}>
          AiQ
        </GradientText>{" "}
        · Intelligence That Drives Execution · Chulalongkorn University 2026
      </motion.div>
    </SlideShell>
  );
}
