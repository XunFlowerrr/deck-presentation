...
export function ServicesBreakdown() {
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={servicesBreakdownHeader.label}
        title={servicesBreakdownHeader.title}
        highlight={servicesBreakdownHeader.highlight}
        tagline={servicesBreakdownHeader.tagline}
        marginBottom={20}
      />
