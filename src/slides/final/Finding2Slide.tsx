        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, fontSize: 12, fontWeight: 700 }}>
              <span style={{ color: "#7B2C8F" }}>● Feeling</span>
              <span style={{ color: "#C2185B" }}>● Weighting</span>
            </div>
          </motion.div>
          ...
          {/* Case 3: Averaged (Highlighted with Deep Plum Badge) */}
          <motion.div
            {...cardRise(0.35)}
            style={{
              background: "#FFFFFF",
...
Finding2Slide.slideId = "Finding2";
