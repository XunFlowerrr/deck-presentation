    ...
    <SlideShell glows={GLOWS} contentStyle={{ background: "#FAFAF8" }}>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-around", height: 200, paddingBottom: 16, borderBottom: "2px solid #EEEDEA", position: "relative" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, zIndex: 1 }}>
              <span style={{ fontSize: 14, fontWeight: 800, color: "#888888" }}>0.369</span>
              <div style={{ width: 60, height: 120, background: "#888888", borderRadius: "8px 8px 0 0" }} />
              <span style={{ fontSize: 13, fontWeight: 800, color: "#888888", textAlign: "center" }}>
            ...
            {/* Bar 2: MIR */}
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, zIndex: 1 }}>
              <span style={{ fontSize: 14, fontWeight: 800, color: "#888888" }}>0.385</span>
              <div style={{ width: 60, height: 146, background: "#888888", borderRadius: "8px 8px 0 0" }} />
              <span style={{ fontSize: 13, fontWeight: 800, color: "#888888", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, zIndex: 1, position: "relative" }}>
              ...
              <div
                style={{
                  ...
                  borderRadius: 6,
                  whiteSpace: "nowrap",
                  boxShadow: "0 2px 6px rgba(29, 158, 117, 0.05)",
                }}
              >
                no traits · interpretable
              </div>

              <span style={{ fontSize: 15, fontWeight: 900, color: "#1D9E75" }}>0.380</span>
              <div style={{ width: 60, height: 138, background: "#1D9E75", borderRadius: "8px 8px 0 0", boxShadow: "0 4px 12px rgba(29, 158, 117, 0.2)" }} />
              <span style={{ fontSize: 13, fontWeight: 900, color: "#1D9E75", textAlign: "center" }}>
          ...
          {/* Sub-tagline */}
          <div style={{ textAlign: "center", fontSize: 14, fontWeight: 800, color: "#222222", marginTop: 4 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            <h4 style={{ margin: "0 0 8px", fontSize: 18, fontWeight: 800, color: "#222222" }}>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 13.5, color: "#888888", lineHeight: 1.45, fontWeight: 500 }}>
