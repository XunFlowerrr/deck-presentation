  ...
  return (
    <SlideShell glows={GLOWS} contentStyle={{ background: "#FCFAF6" }}>
      <SlideHeader
        ...
        title="Finding 1: Emotion Mediation "
        highlight="Improves Accuracy."
      />
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            <div style={{ fontSize: 56, fontWeight: 950, color: "#C24F71", lineHeight: 1 }}>
              +0.066
            </div>
            <div>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 14, color: "#626B74", fontWeight: 700 }}>
          ...
          >
            ...
            >
              <div style={{ fontSize: 12, color: "#626B74", fontWeight: 800 }}>Helped Share</div>
              <div style={{ fontSize: 28, fontWeight: 950, color: "#C24F71", marginTop: 4 }}>
                92.8%
              </div>
              <div style={{ fontSize: 11, color: "#9CA3AF", marginTop: 2, fontWeight: 600 }}>of user-domain units</div>
            </div>
            ...
            <div
              style={{
                background: "#FFFFFF",
                border: "1px solid rgba(194, 79, 113, 0.12)",
                borderRadius: 14,
                padding: "16px",
                textAlign: "center",
            ...
            >
              <div style={{ fontSize: 12, color: "#626B74", fontWeight: 800 }}>Support Effect</div>
              <div style={{ fontSize: 20, fontWeight: 900, color: "#2D3136", marginTop: 10 }}>
                Dose-Response
              </div>
              <div style={{ fontSize: 11, color: "#9CA3AF", marginTop: 2, fontWeight: 600 }}>More ratings = higher gain</div>
            </div>
          </motion.div>
          ...
          >
            <strong style={{ color: "#C24F71" }}>Dose-Response Effect: </strong>
        ...
        <motion.div {...cardRise(0.25)} style={{ width: "100%" }}>
          <PlotImage
            ...
            fallbackStats={[
              { label: "Direct CCC", value: "0.293", color: "#2D3136" },
              { label: "Hybrid CCC", value: "0.359", color: "#C24F71" },
              { label: "Helped Share", value: "92.8%", color: "#C24F71" },
            ]}
