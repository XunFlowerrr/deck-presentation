            ...
            return (
              <div key={node.label} style={{ display: "flex", alignItems: "center", position: "relative" }}>
                ...
                >
                  ...
                  <h4 style={{ fontSize: 19, fontWeight: 800, color: "#4A1533", margin: 0, textAlign: "center", lineHeight: 1.2 }}>
                    {node.label}
                  </h4>
                  ...
                  <div style={{ fontSize: 14.5, color: "#6B5B6E", textAlign: "center", lineHeight: 1.4 }}>
                    {node.detail}
                  </div>
                  ...
                  <div
                    style={{
                      marginTop: "auto",
                      fontSize: 12, color: "#6B5B6E", fontWeight: 500, textAlign: "center",
