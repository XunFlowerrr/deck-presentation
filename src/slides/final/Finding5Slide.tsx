    ...
    <SlideShell glows={GLOWS}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            <span style={{ fontSize: 11, fontWeight: 900, color: "#C2185B", textTransform: "uppercase", letterSpacing: "0.08em" }}>
              Key Theoretical Insight
            </span>
            <div style={{ fontSize: 24, fontWeight: 800, color: "#4A1533", lineHeight: 1.3 }}>
              &ldquo;Strong models already know about emotions.&rdquo;
            </div>
            <p style={{ margin: "4px 0 0", fontSize: 14.5, color: "#6B5B6E", lineHeight: 1.5, fontWeight: 500 }}>
        ...
        <motion.div {...cardRise(0.25)}>
          <PlotImage
            ...
            fallbackStats={[
              { label: "Trend", value: "Diminishing returns", color: "#C2185B" },
              { label: "Reason", value: "Redundant emotional features", color: "#6B5B6E" },
              { label: "Model Backbone", value: "Qwen-4B VLM", color: "#7B2C8F" },
            ]}
