...
import { webCapabilities2Header } from "../content/slides/system-slides";
...
export function WebCapabilities2() {
  ...
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={webCapabilities2Header.label}
        title={webCapabilities2Header.title}
        highlight={webCapabilities2Header.highlight}
        tagline={webCapabilities2Header.tagline}
        marginBottom={32}
      />
