...
import { webCapabilitiesHeader } from "../content/slides/system-slides";
...
export function WebCapabilities() {
  ...
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={webCapabilitiesHeader.label}
        title={webCapabilitiesHeader.title}
        highlight={webCapabilitiesHeader.highlight}
        tagline={webCapabilitiesHeader.tagline}
        marginBottom={32}
      />
