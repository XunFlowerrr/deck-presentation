...
import { tocItems, tocHeader } from "../content/slides/toc";
import type { TOCItem } from "../content/slides/toc";
...
export function TableOfContents({ items = tocItems }: TOCSlideProps) {
  const goTo = useGoTo();
  return (
    <SlideShell>
      <SlideHeader
        label={tocHeader.label}
        title={tocHeader.title}
        highlight={tocHeader.highlight}
        tagline={tocHeader.tagline}
      />
