...
import { interactiveRAGHeader } from "../content/slides/system-slides";
...
export function InteractiveRAG() {
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={interactiveRAGHeader.label}
        title={interactiveRAGHeader.title}
        highlight={interactiveRAGHeader.highlight}
        tagline={interactiveRAGHeader.tagline}
        marginBottom={40}
      />
