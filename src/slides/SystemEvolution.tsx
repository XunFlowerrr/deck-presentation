...
const ICON_MAP = {
  LegacySearch: <LegacySearchIcon />,
  NaiveRag: <NaiveRagIcon />,
  ProposedSystem: <ProposedSystemIcon />,
} as const;
...
export function SystemEvolution() {
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={systemEvolutionHeader.label}
        title={systemEvolutionHeader.title}
        highlight={systemEvolutionHeader.highlight}
        tagline={systemEvolutionHeader.tagline}
        marginBottom={32}
      />
        ...
        {levels.map((lvl, i) => (
          ...
          >
            ...
            >
              ...
              >
                <ThaiText en={lvl.desc.en}>{lvl.desc.th}</ThaiText>
              </p>
            </div>
