...
import {
  members as MEMBERS,
  meetTheTeamHeader,
} from "../content/slides/meet-the-team";
...
export function MeetTheTeam() {
  ...
  return (
    ...
    >
      ...
      >
        <SlideHeader
          label={meetTheTeamHeader.label}
          title={meetTheTeamHeader.title}
          highlight={meetTheTeamHeader.highlight}
          tagline={meetTheTeamHeader.tagline}
        />
