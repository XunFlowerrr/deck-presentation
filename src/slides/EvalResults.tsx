...
import {
  metrics as METRICS,
  evalResultsHeader,
} from "../content/slides/eval-results";
...
export function EvalResults() {
  return (
    ...
    >
      <SlideHeader
        label={evalResultsHeader.label}
        title={evalResultsHeader.title}
        highlight={evalResultsHeader.highlight}
        tagline={evalResultsHeader.tagline}
      />
          ...
          {METRICS.map((m, i) => (
            ...
            >
              ...
              >
                ...
                >
                  <ThaiText en={m.desc.en}>{m.desc.th}</ThaiText>
                </p>
