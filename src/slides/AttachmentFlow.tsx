...
import { attachmentFlowHeader } from "../content/slides/system-slides";
...
export function AttachmentFlow() {
  ...
  return (
    <SlideShell glows={GLOWS}>
      <SlideHeader
        label={attachmentFlowHeader.label}
        title={attachmentFlowHeader.title}
        highlight={attachmentFlowHeader.highlight}
        tagline={attachmentFlowHeader.tagline}
        marginBottom={20}
      />
