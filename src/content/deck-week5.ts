...
// Import Week 5 slide components
...
const NoiseCeilingQuestionSlide = defineSlide(NoiseCeilingQuestionWeek4, 'NoiseCeilingQuestionWeek5');
const HumanDisagreementSlide = defineSlide(HumanDisagreementWeek4, 'HumanDisagreementWeek5');
const EmotionHelpFramingSlide = defineSlide(EmotionHelpFramingWeek4, 'EmotionHelpFramingWeek5');
...
// Backup slides
const QA1Slide = defineSlide(QA1DeltaComputationWeek4, 'QA1DeltaComputationWeek5');
const QA2Slide = defineSlide(QA2DirectConfoundWeek4, 'QA2DirectConfoundWeek5');
const QA3Slide = defineSlide(QA3DataLeakageWeek4, 'QA3DataLeakageWeek5');
const QA4Slide = defineSlide(QA4EmoRExactlyWeek4, 'QA4EmoRExactlyWeek5');
const QA5Slide = defineSlide(QA5PValueInterpretationWeek4, 'QA5PValueInterpretationWeek5');
const QA6Slide = defineSlide(QA6MultipleComparisonsWeek4, 'QA6MultipleComparisonsWeek5');
const QA7Slide = defineSlide(QA7FailureCasesWeek4, 'QA7FailureCasesWeek5');
const QA8Slide = defineSlide(QA8MetricChoiceWeek4, 'QA8MetricChoiceWeek5');
